...
class OrderManager:
    def __init__(self, db: Session):
        ...
        # --- MODIFIED: Removed ' (2)' from the filename to match your file ---
        with open("ml_models/delivery_time_model.pkl", "rb") as f:
            self.model = joblib.load(f)
        
        # Keep these as (2) because your folder still has them named this way
    ...
    def TrafficLevel(self, lat, lon):
        ...
        # --- MODIFIED: Updated origin to Bengaluru Warehouse coordinates ---
